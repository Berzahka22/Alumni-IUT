...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
     ...
     <a href="{{ route('profilutilisateur') }}"><i class="bi bi-person-circle" style="font-size: 1.8rem; cursor: pointer;"></i></a>
  </header>
        ...
        <div class="row gy-4">
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item d-flex position-relative h-100">
              <i class="bi bi-person-raised-hand icon flex-shrink-0"></i>
              <div>
                <h4 class="title"><a href=" https://chat.whatsapp.com/LDPIfoJtG0n2hK4sPq8iLh" class="stretched-link">Retrouver Ses Anciens Camarades</a></h4>
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item d-flex position-relative h-100">
              ...
              <div>
                <h4 class="title"><a href="{{ route('emploi') }}" class="stretched-link">Offres D'emplois/ Stages</a></h4>
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item d-flex position-relative h-100">
              ...
              <div>
                <h4 class="title"><a href="#" class="stretched-link">Objets de Recherches</a></h4>
                <p class="description">Découvrir l'ensemble des projets des Etudiants de l'IUT lors du programme PackT</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="service-item d-flex position-relative h-100">
              ...
              <div>
                <h4 class="title"><a href="service-details.html" class="stretched-link">Projets Réalisés</a></h4>
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="500">
            <div class="service-item d-flex position-relative h-100">
              <i class="bi bi-mortarboard-fill icon flex-shrink-0"></i><i class=""></i>
              <div>
                <h4 class="title"><a href="#" class="stretched-link">Etudiants Brillants de l'IUT</a></h4>
                <p class="description">Découvrir les Majors de chaque Parcours et chaque Mention</p>
              </div>
            </div>
          </div><!-- End Service Item -->
        </div>
...
<section id="Emplois/Stages" class="Emplois/Stages section section-bg dark-background">
  ...
  <footer id="footer" class="footer dark-background">
    ...
    <div class="container text-center mt-4">
      <p>© Copyright <strong class="sitename">AluMni-IUT</strong> </p>
      <div class="credits">
        Designed by <a href="#">BerZahka</a>
      </div>
    </div>
  </footer>
